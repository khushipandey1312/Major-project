...
# # Load XGBoost model, label encoder, and scaler
...
#     ],
#     title="Heartbeat Condition Detection",
#     description="Upload a heartbeat audio file (.wav) to predict the heart condition using a trained XGBoost model."
# ).launch()
